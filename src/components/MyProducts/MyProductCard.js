...
const MyProductCard = ({ myProduct, refetch }) => {
  const handleProductDelete = (id) => {
    fetch(`https://phone-resale-bazar-server.vercel.app/myproduct/${id}`, {
      method: "DELETE",
      headers: {
  ...
  const handleDelete = (id) => {
    fetch(`https://phone-resale-bazar-server.vercel.app/myBookingDelete/${id}`, {
      method: "DELETE",
      headers: {
        authorization: `bearer ${localStorage.getItem("accessToken")}`,
      },
  ...
  const handleProductAdvertise = (id) => {
    fetch(`https://phone-resale-bazar-server.vercel.app/advertiseproduct/${id}`, {
      method: "PUT",
      headers: {
        authorization: `bearer ${localStorage.getItem("accessToken")}`,
      },
